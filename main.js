...
function submit()
{
    ...
    nombre_alumno_aray.push(nombre_1);
    nombre_alumno_aray.push(nombre_2);
    nombre_alumno_aray.push(nombre_3);
    nombre_alumno_aray.push(nombre_4);

    console.log(nombre_alumno_aray);

    document.getElementById("ver_nombre").innerHTML=nombre_alumno_aray;
